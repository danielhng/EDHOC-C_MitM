...
void *parse_edhoc_sym_msg_3(cbor_item_t *MSG, char *msg1, FILE *keyfile_pu, FILE *keyfile_pr, unsigned char *party)
{
    ...
    size_t ciphertext_with_tag_len = cbor_bytestring_length(cbor_array_get(MSG_3.COSE_ENC_3, 2));    unsigned char *ciphertext = malloc(ciphertext_with_tag_len - AES_CCM_64_64_128_tag_sz);
    memcpy(ciphertext, ciphertext_with_tag, ciphertext_with_tag_len - AES_CCM_64_64_128_tag_sz);
    unsigned char *tag = malloc(AES_CCM_64_64_128_tag_sz);
    memcpy(tag, ciphertext_with_tag + ciphertext_with_tag_len - AES_CCM_64_64_128_tag_sz, AES_CCM_64_64_128_tag_sz);
